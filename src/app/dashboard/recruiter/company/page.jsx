...
import { 
  ...
  TextArea, 
  Chip
} from "@heroui/react"; // useDisclosure বাদ দেওয়া হয়েছে

const RecruiterCompanyProfilePage = () => {
  // useDisclosure এর বদলে সাধারণ useState ব্যবহার করা হলো
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setCompany(formData);
      setLoading(false);
      setIsOpen(false); // ফর্ম সাবমিটের পর মডাল ক্লোজ হবে
    }, 1000);
  };
                  ...
                  <Fieldset className="space-y-6 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
                      ...
                      <Select
                        ...
                        selectedKey={formData.industry ? new Set([formData.industry]) : undefined}
                      ...
                      >
                        ...
                        <Select.Popover className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-xl text-zinc-200 min-w-[250px]">
                          <ListBox className="p-1">
                            ...
                            <ListBox.Item id="Finance" textValue="Finance" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">Finance</ListBox.Item>
                            <ListBox.Item id="Healthcare" textValue="Healthcare" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">Healthcare</ListBox.Item>
                            <ListBox.Item id="Education" textValue="Education" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">Education</ListBox.Item>
                          </ListBox>
                        </Select.Popover>
                      </Select>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full items-start">
                      <Select
                        ...
                        selectedKey={formData.employeeCount ? new Set([formData.employeeCount]) : undefined}
                      ...
                      >
                        ...
                        <Select.Popover className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-xl text-zinc-200 min-w-[250px]">
                          <ListBox className="p-1">
                            <ListBox.Item id="1-10 employees" textValue="1-10 employees" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">1-10 employees</ListBox.Item>
                            <ListBox.Item id="11-50 employees" textValue="11-50 employees" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">11-50 employees</ListBox.Item>
                            <ListBox.Item id="51-200 employees" textValue="51-200 employees" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">51-200 employees</ListBox.Item>
                            <ListBox.Item id="201+ employees" textValue="201+ employees" className="hover:bg-zinc-800 p-2 rounded-lg cursor-pointer text-sm">201+ employees</ListBox.Item>
                          </ListBox>
                        </Select.Popover>
                      </Select>
